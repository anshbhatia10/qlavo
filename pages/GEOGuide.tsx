...
const GEOGuide: React.FC = () => {
  useEffect(() => {
    document.title = 'What is Generative Engine Optimization (GEO)? — 2026 Guide | Qlavo';
    const meta = document.querySelector('meta[name="description"]');
    if (meta) {
      meta.setAttribute('content', 'Generative Engine Optimization (GEO) explained in plain English. How to get your brand cited by ChatGPT, Perplexity, Gemini, and Google AI Overviews. A complete 2026 guide.');
    }
  }, []);
      ...
      <section className="pb-20 md:pb-28 px-6">
        <div className="max-w-4xl mx-auto space-y-16">
          {sections.map((section) => (
            <div key={section.title} className="bento-card p-8 md:p-10">
