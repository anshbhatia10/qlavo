        ...
        <div className="max-w-3xl mx-auto reveal-scale">
          <div className="bento-card p-8 md:p-12 gradient-border" ref={ref}>
            ...
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                ...
                <p className="text-[10px] text-zinc-500 uppercase tracking-wider">Illustrative example — not a check of your business</p>
              </div>
              {/* Live indicator */}
              <div className="ml-auto flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
                <span className="text-[10px] text-emerald-400 font-medium uppercase tracking-wider">Example</span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-red-400 font-medium">Example only — no business has been checked</span>
              </div>
              <a
                href="/contact"
                className="btn-primary inline-flex items-center gap-2 px-6 py-3 text-xs font-semibold"
              >
                Discuss Your Visibility →
              </a>
            </div>
          </div>
          ...
          <div className="text-center mt-8 reveal">
            <p className="text-zinc-500 text-sm font-light">
              AI answers can include some brands and omit others. <br className="hidden md:block" />
              Actual visibility needs recorded checks of relevant buyer questions.
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <>
      <SEOMeta
        ...
        description="Qlavo is a worldwide B2B GEO agency. Get cited by ChatGPT, Gemini, Perplexity, and Google AI Overviews. Founded 2025 by Ansh Bhatia. HQ New Delhi. GEO strategy, content, entity clarity and technical optimization for brands worldwide."
        path="/"
      />
