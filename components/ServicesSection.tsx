...
const stats = [
  {
    value: 'Discover',
    label: 'Understand the questions buyers ask and the sources AI answers cite',
    icon: TrendingUp,
  },
  {
    value: 'Clarify',
    label: 'Make your content and business information clear and consistent',
    icon: BarChart3,
  },
  {
    value: 'Measure',
    label: 'Record observations and track changes against an agreed baseline',
    icon: Cpu,
  },
];
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="text-center mb-14 reveal">
            ...
            <h2 className="font-grotesk text-3xl md:text-4xl lg:text-5xl font-bold text-white mt-4 tracking-tight">
              A clearer presence. <span className="text-gradient-emerald">A measured approach.</span>
            </h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center mb-16 md:mb-20 reveal">
            ...
            <p className="text-zinc-400 text-base md:text-lg font-light mt-4 max-w-2xl mx-auto">
              ...
              We research the answers and work on the content, entity and technical gaps worth addressing.
            </p>
          </div>
              ...
              <div className="flex flex-col md:flex-row gap-8 md:gap-12 relative z-10">
                <div className="flex-1">
                  ...
                  <p className="text-zinc-400 font-light leading-relaxed mb-6">
                    ...
                    It builds on SEO fundamentals with entity clarity, structured data,
                    and consistency across every platform AI trusts.
                  </p>

                  <ul className="space-y-3 mb-8">
                    {[
                      'Consistent business information across relevant profiles and sources',
                ...
                <div className="hidden md:flex flex-col justify-center items-center gap-6 shrink-0 border-l border-white/5 pl-10">
                  <div className="text-center">
                    <p className="font-grotesk text-4xl font-bold text-gradient-emerald">Research</p>
                    <p className="text-xs text-zinc-500 mt-2 max-w-[16ch]">buyer questions and cited sources</p>
                  </div>
                  <div className="w-12 h-px bg-white/10" />
                  <div className="text-center">
                    <p className="font-grotesk text-4xl font-bold text-white">Clarity</p>
                    <p className="text-xs text-zinc-500 mt-2 max-w-[16ch]">content, entities and technical foundations</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-28 pt-20 border-t border-white/5">
            <div className="text-center mb-16 reveal">
              ...
              <h3 className="font-grotesk text-3xl md:text-4xl font-bold text-white mt-4 tracking-tight">
                From research to <span className="text-gradient-emerald">focused action</span>.
              </h3>
            </div>
              ...
              {[
                {
                  ...
                  step: '01',
                  title: 'Audit',
                  desc: 'We agree buyer questions and engines, record real answers and sources, and compare relevant competitors.'
                },
                {
                  icon: FileText,
                  step: '02',
                ...
                },
                {
                  ...
                  step: '04',
                  title: 'Monitor',
                  desc: 'Repeat agreed checks and record changes, including misses. Reporting separates observations from interpretation.'
                }
              ].map((item, i) => {
          ...
          <div className="mt-28 p-8 md:p-14 relative overflow-hidden rounded-[28px] gradient-border bg-gradient-to-br from-zinc-900/80 to-black/80 backdrop-blur-xl text-center reveal-scale">
            ...
            <div className="relative z-10">
              <h3 className="font-grotesk text-2xl md:text-4xl font-bold text-white mb-4 tracking-tight leading-tight">
                Make AI search part of your growth strategy.
              </h3>
              <p className="text-zinc-400 text-base md:text-lg font-light max-w-xl mx-auto mb-10 leading-relaxed">
                Start with your business goals and current presence. We will agree a practical scope before work begins.
              </p>
              <Link
                to="/contact"
